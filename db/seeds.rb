...
brr_clan_tradeport = Planet.create(:name => 'BrR Clan Tradeport', :credits => 300 )
cimf_station = Planet.create(:name => 'CIMF Station', :credits => 300 )
...
res_station = Planet.create(:name => 'RES Station', :credits => 300 )
