...
bespin = Planet.create(:name => 'Bespin', :credits => 300, :description => 'Bespin:Platform' )
...
concord_dawn = Planet.create(:name => 'Concord Dawn', :credits => 300, :description => 'Concord Dawn' )
corellia = Planet.create(:name => 'Corellia', :credits => 300, :description => 'Naboo Plains' )
coruscant = Planet.create(:name => 'Coruscant', :credits => 300, :description => 'Coruscant' )
dagobah = Planet.create(:name => 'Dagobah', :credits => 300, :description => 'Dagobah' )
#dantooine = Planet.create(:name => 'Dantooine', :credits => 300 )
#deadalis_minefields = Planet.create(:name => 'Deadalis Minefields', :credits => 300 )
deathstar = Planet.create(:name => 'Death Star', :credits => 300, :description => 'Deathstar' )
endor = Planet.create(:name => 'Endor', :credits => 300, :description => 'Endor / Kashyyyk' )
felucia = Planet.create(:name => 'Felucia', :credits => 300, :description => 'Felucia' )
geonosis = Planet.create(:name => 'Geonosis', :credits => 300, :description => 'Geonosis / Concord Dawn' )
haruun_kal = Planet.create(:name => 'Haruun Kal', :credits => 300, :description => 'Haruun Kal' )
hoth = Planet.create(:name => 'Hoth', :credits => 300, :description => 'Hoth / RhenVar:Harbor' )
#hutt_space = Planet.create(:name => 'Hutts Minefields', :credits => 300 )
#ilum = Planet.create(:name => 'Ilum', :credits => 300 )
kamino = Planet.create(:name => 'Kamino', :credits => 300, :description => 'Kamino' )
kashyyyk = Planet.create(:name => 'Kashyyyk', :credits => 300, :description => 'Kashyyyk' )
kessel_asteroids = Planet.create(:name => 'Kessel Asteroids', :credits => 300, :description => 'Polis Massa' )
kuat = Planet.create(:name => 'Kuat', :credits => 300, :description => 'Ord Ibanna' )
mandalore = Planet.create(:name => 'Mandalore', :credits => 300, :description => 'Yavin 4' )
mon_calamari = Planet.create(:name => 'Mon Calamari', :credits => 300, :description => 'Kamino:Tipoca City' )
mustafar = Planet.create(:name => 'Mustafar', :credits => 300, :description => 'Mustafar' )
mygeeto = Planet.create(:name => 'Mygeeto', :credits => 300, :description => 'Mygeeto' )
naboo = Planet.create(:name => 'Naboo', :credits => 300, :description => 'Naboo' )
nal_hutta = Planet.create(:name => 'Nal Hutta', :credits => 300, :description => 'Jabba Palace' )
ord_ibanna = Planet.create(:name => 'Ord Ibanna', :credits => 300, :description => 'Ord Ibanna' )
polis_massa = Planet.create(:name => 'Polis Massa', :credits => 300, :description => 'Polis Massa' )
rattatak = Planet.create(:name => 'Rattatak', :credits => 300, :description => 'Rattatak' )
res_station = Planet.create(:name => 'RES Station', :credits => 0, :tradeport => true )
rhen_var = Planet.create(:name => 'Rhen Var', :credits => 300, :description => 'Rhen Var:Citadel' )
#silken_asteroids = Planet.create(:name => 'Silken Asteroids', :credits => 300 )
tatooine = Planet.create(:name => 'Tatooine', :credits => 300, :description => 'Mos Eisley' )
utapau = Planet.create(:name => 'Utapau', :credits => 300, :description => 'Utapau' )
#vergesso_asteroids = Planet.create(:name => 'Vergesso Asteroids', :credits => 300 )
yavin = Planet.create(:name => 'Yavin', :credits => 300, :description => 'Yavin 4' )
...
Route.create(:vector_a => mygeeto, :vector_b => polis_massa, :distance => 1)
Route.create(:vector_a => mygeeto, :vector_b => coruscant, :distance => 1)

Route.create(:vector_a => yavin, :vector_b => rhen_var, :distance => 1)
Route.create(:vector_a => yavin, :vector_b => polis_massa, :distance => 1)
...
Route.create(:vector_a => coruscant, :vector_b => polis_massa, :distance => 1)
...
Route.create(:vector_a => mandalore, :vector_b => polis_massa, :distance => 1)
...
Route.create(:vector_a => concord_dawn, :vector_b => polis_massa, :distance => 1)
...
Route.create(:vector_a => corellia, :vector_b => polis_massa, :distance => 1)
