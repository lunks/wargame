bespin = Planet.create(:name => 'Bespin', :credits => 400, :description => 'Bespin Cloud City' )
brr_station = Planet.create(:name => 'BrR Station', :credits => 0, :tradeport => true, :description => 'Tradeport' )
cimf_station = Planet.create(:name => 'CIMF Station', :credits => 0, :tradeport => true, :description => 'Tradeport' )
concord_dawn = Planet.create(:name => 'Concord Dawn', :credits => 400, :description => 'Raxus Prime Dune Sea' )
corellia = Planet.create(:name => 'Corellia', :credits => 400, :description => 'Corellia' )
...
endor = Planet.create(:name => 'Endor', :credits => 400, :description => 'Kashyyyk' )
felucia = Planet.create(:name => 'Felucia', :credits => 400, :description => 'Felucia' )
geonosis = Planet.create(:name => 'Geonosis', :credits => 400, :description => 'Geonosis / Raxus Prime' )
...
res_station = Planet.create(:name => 'RES Station', :credits => 0, :tradeport => true, :description => 'Tradeport' )
