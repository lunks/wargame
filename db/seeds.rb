alderaan = Planet.create(:name => 'Alderaan', :credits => 850 )
bespin = Planet.create(:name => 'Bespin', :credits => 850 )
bothauwi = Planet.create(:name => 'Bothauwi', :credits => 800 )
byss = Planet.create(:name => 'Byss', :credits => 700 )
corellia = Planet.create(:name => 'Corellia', :credits => 1000 )
coruscant = Planet.create(:name => 'Coruscant', :credits => 900 )
dagobah = Planet.create(:name => 'Dagobah', :credits => 800 )
dantooine = Planet.create(:name => 'Dantooine', :credits => 750 )
endor = Planet.create(:name => 'Endor', :credits => 750 )
eriadu = Planet.create(:name => 'Eriadu', :credits => 900 )
felucia = Planet.create(:name => 'Felucia', :credits => 800 )
geonosis = Planet.create(:name => 'Geonosis', :credits => 800 )
hoth = Planet.create(:name => 'Hoth', :credits => 850 )
ilum = Planet.create(:name => 'Ilum', :credits => 750 )
kamino = Planet.create(:name => 'Kamino', :credits => 700 )
...
moncalamari = Planet.create(:name => 'Mon Calamari', :credits => 700 )
mustafar = Planet.create(:name => 'Mustafar', :credits => 800 )
mygeeto = Planet.create(:name => 'Mygeeto', :credits => 850 )
naboo = Planet.create(:name => 'Naboo', :credits => 850 )
nalhutta = Planet.create(:name => 'Nal Hutta', :credits => 800 )
polismassa = Planet.create(:name => 'Polis Massa', :credits => 750 )
ryloth = Planet.create(:name => 'Ryloth', :credits => 700 )
tatooine = Planet.create(:name => 'Tatooine', :credits => 850 )
utapau = Planet.create(:name => 'Utapau', :credits => 700 )
